...
@SpringBootTest(classes = ProductExternalController.class)
public class ProductExternalControllerBase {
    ...
    public void setupTest() {
        ...
        // then
        RestAssuredMockMvc.standaloneSetup(productExternalController, new ProductsExceptionHandler());
    }
